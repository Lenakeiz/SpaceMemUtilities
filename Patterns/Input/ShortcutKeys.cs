...
namespace SpaceMem.Patterns.Input
{
    /// <summary>
    ...
    public class ShortcutKeys
    {
        ...
        public bool IsActive()
        {
            ...
            {
                if (_keys[keyIndex] != KeyCode.None && !UnityEngine.Input.GetKey(_keys[keyIndex])) return false;
            }
            ...
            if (_useModifiers)
            {
                if (_lCtrl && !UnityEngine.Input.GetKey(KeyCode.LeftControl)) return false;
                if (_lCmd && !UnityEngine.Input.GetKey(KeyCode.LeftCommand)) return false;
                if (_lAlt && !UnityEngine.Input.GetKey(KeyCode.LeftAlt)) return false;
                if (_lShift && !UnityEngine.Input.GetKey(KeyCode.LeftShift)) return false;
            }
            ...
            if (_useMouseButtons)
            {
                if (_lMouseBtn && !UnityEngine.Input.GetMouseButton((int)MouseButton.Left)) return false;
                if (_rMouseBtn && !UnityEngine.Input.GetMouseButton((int)MouseButton.Right)) return false;
                if (_mMouseBtn && !UnityEngine.Input.GetMouseButton((int)MouseButton.Middle)) return false;
            }
        ...
        public bool IsActiveInCurrentFrame()
        {
            ...
            for (int keyIndex = 0; keyIndex < _numberOfKeys; ++keyIndex)
            {
                if (_keys[keyIndex] != KeyCode.None && !UnityEngine.Input.GetKeyDown(_keys[keyIndex])) return false;
            }
            ...
            if (_useMouseButtons)
            {
                if (_lMouseBtn && !UnityEngine.Input.GetMouseButtonDown((int)MouseButton.Left)) return false;
                if (_rMouseBtn && !UnityEngine.Input.GetMouseButtonDown((int)MouseButton.Right)) return false;
                if (_mMouseBtn && !UnityEngine.Input.GetMouseButtonDown((int)MouseButton.Middle)) return false;
            }
        ...
        public void RenderView(MonoBehaviour parentMono)
        {
            ...
            {
                Undo.RecordObject(parentMono, "Changed Number of Keys");
            ...
            for (int keyIndex = 0; keyIndex < _numberOfKeys; ++keyIndex)
            {
                ...
                {
                    Undo.RecordObject(parentMono, "Changed Key");
            ...
            {
                Undo.RecordObject(parentMono, "Changed Use Modifiers");
            ...
            {
                Undo.RecordObject(parentMono, "Changed Use Mouse Buttons");
        ...
        {
            if (UnityEngine.Input.GetKey(KeyCode.LeftControl)) return true;
            if (UnityEngine.Input.GetKey(KeyCode.LeftCommand)) return true;
            if (UnityEngine.Input.GetKey(KeyCode.LeftAlt)) return true;
        ...
        {
            if (UnityEngine.Input.GetMouseButton((int)MouseButton.Left)) return true;
            if (UnityEngine.Input.GetMouseButton((int)MouseButton.Right)) return true;
            if (UnityEngine.Input.GetMouseButton((int)MouseButton.Middle)) return true;
